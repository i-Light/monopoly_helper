...
import 'package:monopoly_helper/data/datasets/navigation_tips_data.dart';
...
class MarqueeNavButton extends StatefulWidget {
  const MarqueeNavButton({super.key, required this.isOpen, required this.onToggle});
...
class _MarqueeNavButtonState extends State<MarqueeNavButton>
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
      child: Padding(
        padding: EdgeInsets.fromLTRB(12 * scale, 6 * scale, 12 * scale, 10 * scale),
        child: Material(
                        ...
                        child: LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            return AnimatedBuilder(
                              ...
                              builder: (context, _) {
                                final dx = startX + (endX - startX) * _controller.value;
